...
import { 
  Search, Plus, Package, Edit2, Trash2, Plane, Ship, Box, Save, Calculator, 
...
export const RestockModule: React.FC = () => {
  ...
  const renderDetailModal = () => {
    ...
    const showSidebar = activeTab !== 'finance'; // Sidebar visible for Supply AND Logistics
