      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="bg-red-50/50 border border-red-100 rounded-2xl p-5 flex flex-col justify-between hover:shadow-sm transition-shadow">
            <div className="flex items-center gap-2 text-red-600 font-bold text-sm mb-3">
               <AlertCircle size={16} /> 供应链预警
            </div>
            <div className="space-y-3">
               <div className="flex justify-between items-center bg-white p-3 rounded-xl border border-red-100">
                  <span className="text-xs font-semibold text-gray-800">原材料短缺</span>
                  <span className="text-[10px] bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-bold">严重</span>
               </div>
               <div className="flex justify-between items-center bg-white p-3 rounded-xl border border-red-100">
                  <span className="text-xs font-semibold text-gray-800">良品率下降</span>
                  <span className="text-[10px] bg-orange-100 text-orange-600 px-2 py-0.5 rounded-full font-bold">警告</span>
               </div>
            </div>
         </div>
            ...
            <div className="flex-1 flex flex-col justify-center">
               <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1">
                     <div className="text-sm font-bold text-gray-800">洛杉矶港 (LA Port) 拥堵</div>
                     <div className="text-xs text-gray-500">预计延误 +4 天</div>
                  </div>
               </div>
