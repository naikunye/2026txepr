    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 border-b border-white/10 pb-6">
         <div>
            ...
            <h1 className="text-4xl font-black text-white tracking-wider text-glow">全域指挥中心</h1>
         </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[180px]">
         ...
         <div className="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 tech-border p-0 relative overflow-hidden group">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-cyber-panel via-black to-black opacity-90 z-0"></div>
            ...
            <div className="relative z-10 p-8 h-full flex flex-col justify-between">
               <div>
                  ...
                  <p className="text-gray-400 mt-1 font-mono text-xs">实时追踪 12 个活跃物流节点</p>
               </div>
               
               {/* Status Pills */}
               <div className="flex gap-3">
                  <div className="px-4 py-2 border-l-2 border-cyber-green bg-black/50 backdrop-blur text-xs font-mono text-white">
                     <span className="text-cyber-green mr-2 animate-pulse">●</span> 美西仓: 活跃
                  </div>
                  <div className="px-4 py-2 border-l-2 border-cyber-yellow bg-black/50 backdrop-blur text-xs font-mono text-white">
         ...
         <div className="col-span-1 md:col-span-1 lg:col-span-2 row-span-1 tech-border p-6 relative overflow-hidden">
            <div className="flex justify-between items-start relative z-10">
               <div>
                  <div className="text-xs font-mono text-gray-400 uppercase tracking-widest">净营收 (Net Revenue)</div>
                  <div className="text-3xl font-bold text-white mt-1 text-glow">¥1,245,890</div>
               </div>
         ...
         <div className="tech-border p-6 flex flex-col justify-between hover:bg-white/5 transition-colors">
            ...
            <div>
               <div className="text-2xl font-bold text-white">12 SKU</div>
               <div className="text-xs text-gray-500 font-mono">库存水位低于阈值</div>
            </div>
      ...
      <div className="mt-8">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Insight Card 1 */}
            <div className="tech-border p-5 flex gap-4 items-center cursor-pointer group">
               ...
               <div>
                  <h4 className="font-bold text-white text-sm">营销 ROI 飙升</h4>
                  <p className="text-xs text-gray-400 leading-tight mt-1">TikTok 广告转化率提升 +24%</p>
               </div>
            </div>
            ...
            <div className="tech-border p-5 flex gap-4 items-center cursor-pointer group">
               ...
               <div>
                  <h4 className="font-bold text-white text-sm">新市场机会</h4>
                  <p className="text-xs text-gray-400 leading-tight mt-1">德国市场对 SKU 20-25 需求激增</p>
               </div>
            </div>
            ...
            <div className="tech-border p-5 flex gap-4 items-center cursor-pointer group">
               ...
               <div>
                  <h4 className="font-bold text-white text-sm">现金流预警</h4>
                  <p className="text-xs text-gray-400 leading-tight mt-1">供应商款项将在 3 天后到期</p>
               </div>
            </div>
